...
function tradeRow(t){
 ...
 shots=(t.beforeImage||t.beforeImageUrl||v.afterImage||v.afterImageUrl)?`<div class="screenshot-actions">${t.beforeImage?`<button type="button" data-shot="${esc(t.beforeImage)}" data-shot-title="Setup screenshot">View setup screenshot</button>`:''}${t.beforeImageUrl?`<button type="button" data-shot="${esc(t.beforeImageUrl)}" data-shot-title="Setup screenshot from Drive">View setup in Drive</button>`:''}${v.afterImage?`<button type="button" data-shot="${esc(v.afterImage)}" data-shot-title="After-trade screenshot">View after screenshot</button>`:''}${v.afterImageUrl?`<button type="button" data-shot="${esc(v.afterImageUrl)}" data-shot-title="After-trade screenshot from Drive">View after in Drive</button>`:''}</div>`:'',
