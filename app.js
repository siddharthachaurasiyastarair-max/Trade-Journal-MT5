...
function renderDashboard(){
 ...
 `<div class="top-actions"><button class="secondary" id="reportsBtn">Reports</button><button class="secondary" id="refreshMt5Btn">Refresh MT5</button><button class="secondary" id="syncMt5Btn">Settings</button><button class="secondary" id="backupBtn">Backup</button></div>`)+
