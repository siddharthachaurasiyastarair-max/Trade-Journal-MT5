const CACHE='tradetrack-v30-reliable-screenshots'; const ASSETS=['./','./index.html','./styles.css?v=29','./app.js?v=29','./manifest.json','./icon-180.png','./icon-192.png','./icon-512.png'];
