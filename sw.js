const CACHE='tradetrack-v24-improved-google-sync'; const ASSETS=['./','./index.html','./styles.css?v=24','./app.js?v=24','./manifest.json','./icon-180.png','./icon-192.png','./icon-512.png'];
